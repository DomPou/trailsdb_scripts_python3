...
from trailsdb_queries_PairwiseIntersect_Two_Feature_Classes_v2 import intersectFeatureClassesFromTrailsdb_returnName_v2
...
#datasetsDict = {"pro":["proposed_info","proposed_signage_info"]}
mainFeaturesIntersectToDict = {}


def intersectMainFeaturesToAll_v2(database_version):
				...
				for featureWithRoot in arcpy.ListFeatureClasses():
					if not mainFeatureName in featureWithRoot:
						if arcpy.Describe(featureWithRoot).shapeType == "Polyline":
							...
							intersectFeatureName = intersectFeatureClassesFromTrailsdb_returnName_v2(mainFeatureName, outDataset, featureName, database_version)
...
#intersectMainFeaturesToAll_v2("trailsdb")